...
<html>
    <head>
        ...
        <title>Add Image Service Page</title>
                        ...
                        <div class="page-title-breadcrumb">
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li><a class="parent-item" href="<c:url value="/manager/services"/>">Service</a>&nbsp;<i class="fa fa-angle-right"></i>
                                 ...
                                 <li class="active">Add Image Service</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box">
                                <div class="card-head">
                                    <header>Add Image Service</header>
                                ...
                                <mvc:form id="aircrafts-form"  action="${pageContext.request.contextPath}/manager/load-imgage-service/${imageEntity.service.id}"  method="post" modelAttribute="imageEntity"
