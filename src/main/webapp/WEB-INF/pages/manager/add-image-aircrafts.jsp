                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box">
                                ...
                                <mvc:form id="aircrafts-form"  action="${pageContext.request.contextPath}/manager/load-imgage-aircrafts/${imageEntity.aircraft.id}"  method="post" modelAttribute="imageEntity"
